...
public class Index {
    public static void main(String[] args) throws IOException {
        ...
        String INDEX_DIRECTORY = "index_dir/";
    ...
    //Sprawdź co się stanie gdy uruchomisz 2 razy program tworzący indeks (nie usuwając
    //plików indeksu ręcznie z dysku między uruchomieniami), tj. jak zachowa się
    //wyszukiwanie? jak zmieni się zawartość katalogu z plikami indeksu?
    //ODP: Indeksy zostały podwojone, wyniki zapytania są podwójne
